...
namespace ABCShoppingMall.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,MultiplexId,SeatsAvailable")] Movie movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,MultiplexId,SeatsAvailable")] Movie movie)
        {
            if (ModelState.IsValid)
            {
